...
const ChapterItem = ({ chapter }: { chapter: TChapter }) => {
  ...
  return (
    <tr
      onClick={gotoChapter}
      className="dark:bg-neutral-900 even:dark:bg-neutral-950/10 border-2 dark:border-neutral-700 rounded-md cursor-pointer hover:bg-rose-600/10 dark:hover:bg-rose-500/10 hover:drop-shadow-shadow dark:hover:drop-shadow-glow"
    >
